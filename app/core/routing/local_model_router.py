...
- SYSTEM     : 查询低风险本机信息（时间、日期、CPU/内存/磁盘/系统状态）或启动白名单应用
...
5. SYSTEM         ← 查询本机状态/时间/日期/CPU/内存/磁盘等低风险信息，或启动白名单应用
