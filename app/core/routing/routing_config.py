...
class RoutingRule:
    ...
    def matches(self, user_input: str, user_lower: str, has_file: bool = False) -> bool:
        if self._requires_file_context and not has_file:
            return False
        if self._exclude_keywords and any(k in user_lower for k in self._exclude_keywords):
            return False
...
EDIT_INTENT_KEYWORDS: List[str] = [
    "修改", "更改", "标注", "批注", "润色", "改写", "校对", "审校",
    "修订", "纠错", "改善", "优化", "调整", "精炼", "通畅", "通顺",
    "流畅", "精简", "凝练", "简洁", "整理", "梳理", "提炼",
    "整体修改", "修一下", "帮我改", "改一改", "改得", "写得",
    "polish", "refine", "revise", "edit", "improve",
]
...
PATH_LIST_KEYWORDS: List[str] = [
    ...
    "找", "查", "看看", "显示", "汇总", "整理",
    "监控", "监视", "停止监控", "自动归类", "提取",
    "关键信息", "合同信息", "解读", "分析", "哪个", "哪些",
    "里面", "这几份", "对比", "哪几", "几个", "几份",
    "路径下", "下有", "下面有", "属于", "什么文件", "文件类型", "下的文件",
]

WEATHER_KEYWORDS: List[str] = [
    "天气", "气温", "下雨吗", "下雨", "下雪吗", "下雪",
    "天气怎么样", "天气怎样", "天气预报", "weather", "温度多少", "穿什么衣服",
]
...
CHART_KEYWORDS: List[str] = [
    ...
    "热力图", "作图", "可视化", "统计图", "数据图",
    "chart", "plot", "graph", "matplotlib", "seaborn", "plotly", "echarts",
]
...
PRICE_ASSETS: List[str] = [
    "原油", "布伦特", "wti", "天然气", "黄金", "白银", "铜",
    "铁矿石", "大豆", "小麦", "棉花", "黄铜", "铝", "锌",
    "铅", "镍", "比特币", "以太坊", "btc", "eth",
    "加密货币", "数字货币", "美元", "欧元", "日元", "英镑", "港币",
    "外汇", "汇率", "a股", "港股", "道琼斯", "纳斯达克", "标普",
    "上证", "深证", "期货", "基金", "债券", "股票",
    "金价", "油价", "银价", "铜价",
]
