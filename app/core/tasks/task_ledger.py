...
class TaskLedger:
    ...
    def create(
        ...
        ``task_id`` is normally generated by the ledger.  Streamed file tasks
        may provide a client-generated id so their progress stream can be
        resumed even before the first lifecycle event reaches the browser.
        """
        task = TaskRecord(
