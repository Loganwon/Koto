"""Proposal building and note-cleaning helpers for doc agent executors."""
...
class ResponseFormatter:
    ...
    def clean_proposal_note(note: str, selection: str, proposed_values: List[str]) -> str:
        ...
        A note is considered redundant when its normalised form matches either
        the current selection or any of the proposed replacement values.
        """
