...
def test_docx_auto_pagination_measures_text_without_reintroducing_a_hidden_break_path():
    ...
    assert "'.koto-inline-page-break-anchor, [data-soft-page-break], .koto-pb-header, .koto-pb-footer'" in src
...
def test_docx_inline_page_breaks_align_to_page_not_paragraph_indent():
    ...
    assert "const pageGeometry = _resolveRenderedDocxPageGeometry(pmDom, pageW, mLeft);" in src
